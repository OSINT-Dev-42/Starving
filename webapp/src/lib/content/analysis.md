...
<iframe src="/doc/graphs/general/restaurants_with_new_reviews.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Distribution of restaurants with new reviews"></iframe>
...
When we consider the deletions, we can look at two cases. For one, google maps now provides a notice, when a restaurant deleted reviews because of defamation. The second case is the deletions that were measured in this experiment. With measured deletions we for now also focus on the total amount of deleted reviews in the time of our experiment.  
A caveat with the measured deletions and new reviews is, that it can not be detected if in between measurements the same amount of reviews was deleted and added, thus only the total change at the time of the measurement can be tracked and visualized.  
...
<iframe src="/doc/graphs/general/gridplot-notice-deletions.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Distribution of restaurants by deleted reviews given by notice"></iframe>
<iframe src="/doc/graphs/general/gridplot-tracked-deletions.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Distribution of restaurants by tracked deleted reviews"></iframe>
...
The plot with the measured deletions also takes into account the reviews that were deleted by users. Furthermore we could also track if only one review was deleted. Thus the plot shows, that 52 out of the 119 restaurants did not have any deleted reviews. There were 31 restaurants with one deleted review and 29 restaurants with two to five deleted reviews. The second class is noticably more common than the google notice shows, which suggests that users activvely deleted their reviews. 

The script, apart from the graphs shown before, mainly creates graphs of restaurants, which show the changement of stars over time. Furthermore it only creates the graphs for restaurants that have changes that are of interest to a user.  
...
The created plots are interactive, so that the user can select and de-select specific graphs, zoom in and move the plot.

The restaurant with the highest increase of reviews from one point of measurement to the next is the "Taste-Trip Restaurant Bochum Innenstadt". The plot of the total amount of reviews is shown in the followng plot:
<iframe src="/doc/graphs/interesting_total_count/Taste-Trip Restaurant Bochum Innenstadt, Bochum .html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Taste-Trip Restaurant — total count of reviews"></iframe>

As seen in the graphs the high delta is in the timespan of May 28th to May 31st. This is a long time between measurements, because it was in the beginning of the project, where the scraper was optimized and did not yet run three times a day. Nevertheless, this example is interesting, because it seems to be a new restaurant with only 16 reviews at the start of our experiment. As of the 15th of July, the restaurant has a total of 58 reviews. A search on the restaurants website shows, that it was opened May 18th (https://taste-trip.de/ueber-uns.html), which confirms, that this restaurant was opened shortly before the start of the experiment.  
...
<iframe src="/doc/graphs/interesting_differences/L'Osteria Bochum Husemann Karree, Bochum Viktoriastraße 14 a.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="L'Osteria Bochum — changement of reviews (delta)"></iframe>

It can be seen, that there are multiple spikes for the  5-star reviews of 5 up to 11 new reviews. Furthermore the graph shows, that there was a deletion of 5 star reviews on the 14th and 15th of July. In these two days there was a deletion of 3 5-star reviews. Restaurants with deletions due to defamation receive a notice on google maps. In this case no notice appeared, thus it can be claimed, that the reviews were deleted by the users.  
...
<iframe src="/doc/graphs/interesting_total_count/L'Osteria Bochum Husemann Karree, Bochum Viktoriastraße 14 a.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="L'Osteria Bochum — total count of reviews"></iframe>

When the 5-star graph is selected, it can be clearly seen, that the reviews increased from 854 to 865 in the 2nd of June. This means, that the restaurant has many reviews and a changement of 11 new reviews is plausible and does not indicate any manipulation.
...
<iframe src="/doc/graphs/interesting_differences/YUMINI, Bochum Viktoriastraße 43-45.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="YUMINI — changement of reviews (delta)"></iframe>

The restaurant has 1422 5-star reviews on the 20th June 2026. With this in mind the change of 10 reviews is less than 1%. Between the 28th of May and the 15th of July the restaurant received 18 new 5 star reviews, 3 new 4-star reviews and 3 new 1-star reviews. In this context an increase of 10 reviews in one day might be indicating towards manipulation, but this short timespan of measurements is not enough to draw any conclusions. With the presumption of innocence we would not indicate this as usage of bots. A potential user on the search for a place to eat can make their own conlcusions and decide if this increase seems legitimate or not.
...
Only 15 of the 119 restaurants have this notice. In our detection system any deletion is detected, this includes user deletions. The focus now lies on the maximum delta for deletions from one measurement to the next.  
...
<iframe src="/doc/graphs/interesting_differences/Trattoria Momo, Bochum .html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Trattoria Momo — changement of reviews (delta)"></iframe>
...
This alone is not sufficient to claim that the reason was not defamation, thus no claim of manipulation can be made in this case.
...
<iframe src="/doc/graphs/interesting_total_count/Fiege's Stammhaus, Bochum Bongardstraße 23.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Fiege's Stammhaus — total count of reviews"></iframe>
<iframe src="/doc/graphs/interesting_differences/Fiege's Stammhaus, Bochum Bongardstraße 23.html"
        width="100%" height="620" style="border:0" loading="lazy"
        title="Fiege's Stammhaus — changement of reviews (delta)"></iframe>
...
Since it is not known what the content of the deleted reviews was, it is not possible to ethically judge, if the deletions were justified. Thus the presumption of innocence still holds and it is up to an enduser to make their own judgement.

To conclude the analysis, we showed different restaurants that show anomalies for the increase and deletion of reviews. It is not possible to clearly label any of the cases as manipulation, thus it is up to an end-user to draw their own conclusions and this project provides a tool to help in the endeavour of finding a suitible restaurant to eat.  
Furthermore the analysis suggests, that a longer measurement time is necessary for a possible recognition of patterns that are not apparent within a timespan of about 2 months. With a longer measurement time, the repetition of what are currently single-time events would become apparent as a pattern. For this the tool created in this project might become useful for users in the future, who want to continue to collect their own data.
